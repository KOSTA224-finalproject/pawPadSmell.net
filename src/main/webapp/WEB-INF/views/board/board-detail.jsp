		...
		<div class="col-sm-9">
			...
			<div class="card mb-2 mt-5">
				<div class="card-header bg-light">
					<i class="fa fa-comment fa">${nick}
						댓글&nbsp;[${list.commentCount}]</i>
				</div>
				<form>
					<div class="card-body">
						...
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><textarea class="form-control"
								...
								<button id="comment-btn-save" type="button"
									class="btn btn-dark mt-3">등록</button></li>
						</ul>
					</div>
				</form>
			</div>
					...
					<ul id="commentbox${li.commentId}" class="list-group">
						<li class="list-group-item d-flex justify-content-between">
							...
							<div class="d-flex">
								...
								<button id="" class="badge btn-warning comment-btn-update"
									data_cid="${li.commentId}" data_content="${li.commentContent }"
									data_cname="${li.memberDTO.nickname}">수정</button>
								<span> | </span>
								<button id="" class="badge btn-danger comment-btn-delete"
