		...
		<div class="row pt-5 h-100">
			<div class="col-lg-7 mx-auto text-center mt-7 mb-5">
				<a href="/"><img src="/myweb/images/logo-2.png"
					style="width: 350px;"></a>
				<form action="/updateMemberAction" method="post">
					<div class="form-floating mb-3">
						<sec:csrfInput />
						<input class="form-control" name="email" type="email"
							id="input_id" / value="${member.email}" readonly> <label for="id">이메일</label> <span
					...
					<div class="form-floating mb-3">
						<input class="form-control" name="name" type="text"
							...
							data-sb-validations="required,password" value="${member.name}" required="required"  /> <label for="password">이름
						</label>
					...
					<div class="form-floating mb-3">
						<input class="form-control" name="nickname" type="text"
							...
							data-sb-validations="required,password" value="${member.nickname}" readonly/> <label for="password">닉네임
						</label>
					...
					<div class="form-floating mb-3">
						<input class="form-control" name="birth" type="date"
							placeholder="name@example.com" data-sb-validations="required" value="${member.birth}"/>
