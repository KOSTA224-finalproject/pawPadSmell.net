				...
				<ul class="pagination" style="margin: 20px 0; display: block; text-align: center;">
					<c:if test="${pagingBean.previousPageGroup}">
						<li class="page-item" style="display: inline-block;"><a class="page-link"
							href="${path}/member/memberpage/${member.memberId}?pageNo=${pagingBean.startPageOfPageGroup-1}">이전
						</a></li>
					</c:if>
					...
					<c:if test="${pagingBean.nextPageGroup}">
						<li class="page-item" style="display: inline-block;"><a class="page-link"
								href="${path}/member/memberpage/${member.memberId}?pageNo=${pagingBean.endPageOfPageGroup+1}">다음</a></li>
					</c:if>
				</ul>
			</nav>
