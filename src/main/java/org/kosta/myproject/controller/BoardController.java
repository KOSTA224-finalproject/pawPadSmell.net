...
//게시글 수정
	...
	@ResponseBody
	public void boardUpdate(@PathVariable("postId") int postId, @PathVariable("boardId") int boardId,
			@PathVariable("categoryId") int categoryId, Model model, BoardDTO boardDTO, Authentication authentication,
			MultipartFile file) throws IllegalStateException, IOException {// 여기 boardDTO에 새로 입력한 내용을 받아옴.
		...
		// boardTemp.setTitle(boardDTO.getTitle());// 위 매개변수 boardTemp로 새롭게 받아온 내용을 기존의
		// 내용에 덮어씌운다.
